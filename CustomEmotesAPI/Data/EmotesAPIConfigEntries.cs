...
namespace LethalEmotesAPI.Data
{
    public class EmotesAPIConfigEntries
    {
        ...
        public ConfigEntry<bool> NearestEmoteTextTutorial;
        ...
        public EmotesAPIConfigEntries(ConfigFile file, string sectionPrefix)
        {
            ...
            NearestEmoteTextTutorial = file.Bind("Global Flags", "Join Emote Tutorial", true, "Guaruntees the join prompt will be in the top left corner");

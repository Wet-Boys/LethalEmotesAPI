...
namespace EmotesAPI
{
    ...
    public static class Settings
    {
        ...
        private static void Yes()
        {
            ...
            DisabledEmotes = CustomEmotesAPI.instance.Config.Bind<string>("No Touch", "Disabled Emotes", "none", "Emotes on this list will not actually play when called to play, probably don't want to touch this here");
